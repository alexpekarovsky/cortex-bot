...
async def allowlist_files(
    ...
    comment: Annotated[Optional[str], Field(description="Optional comment explaining why these hashes are being allowlisted")] = None,
    incident_id: Annotated[Optional[int], Field(description="Optional incident/case ID to associate this allowlist action with")] = None,
